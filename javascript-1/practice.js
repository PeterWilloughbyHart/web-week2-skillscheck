...
iLove("Peter", "A good turkey burger");
...
let total = myNumbers.reduce((value, amount) => value + amount); 
...
forTheLoveOfGeorge = notGeorge.map(function(val) {
	return val = "George";
})
...
let enemies = people.filter(function(obj) {
	return obj.friend === false;
})
...
let totallyAwesome = people.reduce((total, levelNum) => total + levelNum.awesomeLevel, 0);